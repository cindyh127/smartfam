...
function googleTranslateElementInit() {
          new google.translate.TranslateElement({pageLanguage: 'en', layout: google.translate.TranslateElement.InlineLayout.SIMPLE, autoDisplay: false}, 'google_translate_element');
            ...
            function adjustPaddingOfBody(){
                ...
                if (w < 800) {
                    document.body.setAttribute('style', "background-image: url(images/application.png); background-repeat: no-repeat; background-size: cover; min-height: 100vh;padding-left: 0px")
                    document.getElementById('mySidebar').setAttribute('style', 'z-index:3; width: 250px; margin-left:0px; padding-top:90px')
                   
                   
                } else if (w > 800) {
                    document.body.setAttribute('style', "background-image: url(images/application.png); background-repeat: no-repeat; background-size: cover; min-height: 100vh; padding-left: 250px")
